...
function tileTeamworkTactics(my_position,friend_position){
    if(my_position>=friend_position){
        return false;
    }
    else if(my_position<friend_position){
        if((friend_position-my_position)<7){
            console.log(friend_position-my_position);
            return true;
        }
    }
}
console.log(tileTeamworkTactics(3,7));
//time-complexity:O(1);
